...
% 用于从以下文本文件中导入数据的脚本:
%
%    filename: D:\lessons_and_papers\专业课\电磁理论、计算、应用\电磁理论、计算、应用II\论文复现\数据\H_Array\H_Plane_S4_H00.csv
%
% 由 MATLAB 于 2025-11-25 10:22:02 自动生成
...
% 导入数据
H_Plane_S4_H00 = readtable("D:\lessons_and_papers\专业课\电磁理论、计算、应用\电磁理论、计算、应用II\论文复现\数据\H_Array\H_Plane_S4_H00.csv", opts);

%% 转换为输出类型
H_Plane_S4_H00 = table2array(H_Plane_S4_H00);

H0 = H_Plane_S4_H00(1:251,2);
H2 = H_Plane_S4_H00(252:502,2);
H4 = H_Plane_S4_H00(503:753,2);
H6 = H_Plane_S4_H00(754:1004,2);
H8 = H_Plane_S4_H00(1005:1255,2);
H10 = H_Plane_S4_H00(1256:1506,2);
freq = H_Plane_S4_H00(1:251,1);
%% 初始化绘图
y_low = -20;                % Y轴下限
...
hold off;
print('H_Plane_S4_H00', '-dpng', '-r300');  % 保存为300dpi PNG