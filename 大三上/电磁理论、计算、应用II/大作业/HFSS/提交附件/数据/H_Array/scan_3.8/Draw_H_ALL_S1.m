...
% 用于从以下电子表格导入数据的脚本:
%
%    工作簿: D:\lessons_and_papers\专业课\电磁理论、计算、应用\电磁理论、计算、应用II\论文复现\数据\H_Array\scan_3.8\All_S1.xlsx
%    工作表: Sheet1
%
...
% 导入数据
AllS1 = readtable("D:\lessons_and_papers\专业课\电磁理论、计算、应用\电磁理论、计算、应用II\论文复现\数据\H_Array\scan_3.8\All_S1.xlsx", opts, "UseExcel", false);
...
hold off;
print('H_ALL_S1', '-dpng', '-r300');  % 保存为300dpi PNG