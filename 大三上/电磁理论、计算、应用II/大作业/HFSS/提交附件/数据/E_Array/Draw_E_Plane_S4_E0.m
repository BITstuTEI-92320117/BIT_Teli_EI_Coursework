...
% 用于从以下文本文件中导入数据的脚本:
%
%    filename: D:\lessons_and_papers\专业课\电磁理论、计算、应用\电磁理论、计算、应用II\论文复现\数据\E_Array\E_Plane_S4_E0.csv
%
...
% 导入数据
EPlaneS4E0 = readtable("D:\lessons_and_papers\专业课\电磁理论、计算、应用\电磁理论、计算、应用II\论文复现\数据\E_Array\E_Plane_S4_E0.csv", opts);
...
hold off;
print('E_Plane_S4_E0', '-dpng', '-r300');  % 保存为300dpi PNG