...
% 用于从以下文本文件中导入数据的脚本:
%
%    filename: D:\lessons_and_papers\专业课\电磁理论、计算、应用\电磁理论、计算、应用II\论文复现\数据\Ant1\S Parameter Plot 2.csv
%
% 由 MATLAB 于 2025-11-08 16:11:40 自动生成
...
%% 图例
legend('Ant. 2', 'Location', 'southeast', 'FontSize', 10, 'Box', 'off', 'FontName', 'Times New Roman', 'FontWeight','bold');  % 图例设置

%% 保存
set(gca, 'GridAlpha', 0.3, 'MinorGridAlpha', 0.1);
hold off;
print('Ant2_S11', '-dpng', '-r300');  % 保存为300dpi PNG
