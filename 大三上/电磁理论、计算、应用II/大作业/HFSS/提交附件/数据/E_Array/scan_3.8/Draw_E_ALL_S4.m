...
% 导入数据
AllS1 = readtable("D:\lessons_and_papers\专业课\电磁理论、计算、应用\电磁理论、计算、应用II\论文复现\数据\E_Array\scan_3.8\All_S4.xlsx", opts, "UseExcel", false);
...
hold off;
print('E_ALL_S4', '-dpng', '-r300');  % 保存为300dpi PNG