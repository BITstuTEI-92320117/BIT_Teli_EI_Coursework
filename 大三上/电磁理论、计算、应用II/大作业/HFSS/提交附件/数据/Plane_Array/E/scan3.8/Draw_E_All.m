...
% 用于从以下电子表格导入数据的脚本:
%
%    工作簿: D:\lessons_and_papers\专业课\电磁理论、计算、应用\电磁理论、计算、应用II\论文复现\数据\Plane_Array\E\scan3.8\E_All.xlsx
%    工作表: Sheet1
%
% 由 MATLAB 于 2025-11-25 11:21:56 自动生成
...
% 导入数据
HAll = readtable("D:\lessons_and_papers\专业课\电磁理论、计算、应用\电磁理论、计算、应用II\论文复现\数据\Plane_Array\E\scan3.8\E_All.xlsx", opts, "UseExcel", false);
