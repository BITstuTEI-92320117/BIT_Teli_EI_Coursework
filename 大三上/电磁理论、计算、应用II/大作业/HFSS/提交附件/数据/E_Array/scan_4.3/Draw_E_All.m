...
% 用于从以下电子表格导入数据的脚本:
%
%    工作簿: D:\lessons_and_papers\专业课\电磁理论、计算、应用\电磁理论、计算、应用II\论文复现\数据\E_Array\scan_4.3\E_All.xlsx
%    工作表: Sheet1
%
% 由 MATLAB 于 2025-11-13 00:59:55 自动生成
...
% 导入数据
HAll = readtable("D:\lessons_and_papers\专业课\电磁理论、计算、应用\电磁理论、计算、应用II\论文复现\数据\E_Array\scan_4.3\E_All.xlsx", opts, "UseExcel", false);
...
% 添加图例（单曲线，无边框）
legend('-75\circ','-60\circ','-40\circ','-20\circ','0\circ','20\circ','40\circ','60\circ','70\circ','Location', 'northeastoutside', 'Box', 'off', 'FontSize', 10, 'FontWeight', 'bold');  % 图例位于东北方向，无边框，字体加粗
