...
% 用于从以下电子表格导入数据的脚本:
%
%    工作簿: D:\lessons_and_papers\专业课\电磁理论、计算、应用\电磁理论、计算、应用II\论文复现\数据\Plane_Array\D\E_All.xlsx
%    工作表: Sheet1
%
% 由 MATLAB 于 2025-11-27 10:59:51 自动生成
...
% 导入数据
HAll = readtable("D:\lessons_and_papers\专业课\电磁理论、计算、应用\电磁理论、计算、应用II\论文复现\数据\Plane_Array\D\E_All.xlsx", opts, "UseExcel", false);

%% 转换为输出类型
HAll = table2array(HAll);% 提取角度和增益
...
% 添加图例（单曲线，无边框）
legend('-60\circ','-48\circ','-20\circ','0\circ','20\circ','48\circ','60\circ','Location', 'northeastoutside', 'Box', 'off', 'FontSize', 10, 'FontWeight', 'bold');  % 图例位于东北方向，无边框，字体加粗
