...
% 用于从以下文本文件中导入数据的脚本:
%
%    filename: D:\lessons_and_papers\专业课\电磁理论、计算、应用\电磁理论、计算、应用II\论文复现\数据\H_Array\H_Plane_S4_H0.csv
%
% 由 MATLAB 于 2025-11-12 09:05:50 自动生成
...
% 指定列名称和类型
opts.VariableNames = ["Var1", "Var2", "FreqGHz", "dBActiveS41"];
...
% 导入数据
HPlaneS4H = readtable("D:\lessons_and_papers\专业课\电磁理论、计算、应用\电磁理论、计算、应用II\论文复现\数据\H_Array\H_Plane_S4_H0.csv", opts);

%% 转换为输出类型
HPlaneS4H = table2array(HPlaneS4H);
H0 = HPlaneS4H(1:251,2);
H2 = HPlaneS4H(252:502,2);
H4 = HPlaneS4H(503:753,2);
H6 = HPlaneS4H(754:1004,2);
H8 = HPlaneS4H(1005:1255,2);
freq = HPlaneS4H(1:251,1);
%% 初始化绘图
y_low = -25;                % Y轴下限
...
hold off;
print('H_Plane_S4_H0', '-dpng', '-r300');  % 保存为300dpi PNG