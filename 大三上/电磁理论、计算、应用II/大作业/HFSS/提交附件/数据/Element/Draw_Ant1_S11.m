...
%% 绘制曲线
plot(freq, S11_ant1, 'k-.', 'LineWidth', 1.2);  % Ant.1曲线：黑色点划线
...
%% 图例
legend('Ant. 1', 'Location', 'southeast', 'FontSize', 10, 'Box', 'off', 'FontName', 'Times New Roman', 'FontWeight','bold');  % 图例设置

%% 保存
set(gca, 'GridAlpha', 0.3, 'MinorGridAlpha', 0.1);
hold off;
print('Ant1_S11', '-dpng', '-r300');  % 保存为300dpi PNG